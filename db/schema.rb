...
ActiveRecord::Schema.define(version: 2018_08_23_134136) do
  ...
  create_table "calendarupdates", id: :serial, force: :cascade do |t|
    ...
    t.index ["user_id"], name: "index_calendarupdates_on_user_id"
  end
  ...
  create_table "ceramiques", id: :serial, force: :cascade do |t|
    ...
    t.index ["user_id"], name: "index_ceramiques_on_user_id"
  end
  ...
  create_table "promos", id: :serial, force: :cascade do |t|
    t.string "code"
    t.float "percentage"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "users", id: :serial, force: :cascade do |t|
    ...
    t.float "latitude"
    t.float "longitude"
    t.string "first_name", default: "Prénom"
    t.string "last_name", default: "Nom"
    t.string "produit"
    t.string "phone"
    t.string "adress"
    t.string "zip_code"
